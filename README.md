...
Web Audio Inspector is a Chrome extension that adds a "Web Audio" panel to DevTools. This panel allows the user to inspect the `AudioNode` graph generated by Web Audio API JavaScript. Install the extension from its [Chrome Web Store page](https://chrome.google.com/webstore/detail/web-audio-inspector/cmhomipkklckpomafalojobppmmidlgl).
